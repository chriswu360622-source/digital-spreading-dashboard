...
class DashboardPortal:
    def __init__(self) -> None:
        ...
        self.status_var = tk.StringVar(value="Ready. You can refresh or export an offline HTML copy.")
    ...
    def _build_portal(self) -> None:
        ...
        self.close_button.grid(row=2, column=0, columnspan=2, sticky="ew")
    ...
    def _set_busy(self, busy: bool) -> None:
        ...
        for button in (self.open_button, self.refresh_button, self.export_button, self.folder_button, self.close_button):
